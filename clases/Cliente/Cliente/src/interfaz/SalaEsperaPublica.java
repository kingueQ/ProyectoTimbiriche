 ...
 */
public class SalaEsperaPublica extends javax.swing.JFrame implements IActualizable {

    private Jugador jugador;
    private String ip;
    private int port;
    private static SalaEsperaPublica instance;
    ...
    /**
     * Metodo para obtener una instancia única de SalaEsperaPublica, si la instancia no
 ha sido creada, la instancia y la retorna.
     *
     * @return SalaEsperaPublica
     */
    public static SalaEsperaPublica crear() {
        instance = new SalaEsperaPublica();
        return instance;
    }
    
    public static SalaEsperaPublica unirse(){
        instance = new SalaEsperaPublica();
        return instance;
    }
    ...
    public void recibirJugadores(List<Jugador> jugadores) {
        for (int i = 0; i < jugadores.size(); i++) {
            switch (i) {
                case 0:
                    ImageIcon icono = new ImageIcon("src\\Avatares\\" + jugadores.get(i).getRutaAvatar());
                    Image imagenRedimensionada = icono.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
                    ImageIcon iconoRedimensionado = new ImageIcon(imagenRedimensionada);
                    this.lblIcon.setIcon(iconoRedimensionado);
                    this.lblNombre.setText(jugadores.get(i).getNombre());
                    break;
                case 1:
                    ImageIcon icono2 = new ImageIcon("src\\Avatares\\" + jugadores.get(i).getRutaAvatar());
                    Image imagenRedimensionada2 = icono2.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
                    ImageIcon iconoRedimensionado2 = new ImageIcon(imagenRedimensionada2);
                    this.lblIcon2.setIcon(iconoRedimensionado2);
