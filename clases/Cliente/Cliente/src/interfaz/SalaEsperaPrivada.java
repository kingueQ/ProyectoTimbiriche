...
public class SalaEsperaPrivada extends javax.swing.JFrame implements IActualizable {
    ...
    private String ip;
    private int port;
    private static SalaEsperaPrivada instance;
    ...
    private SalaEsperaPrivada() {
        ...
        StringBuilder codigoAleatorio = new StringBuilder(6);
        for (int i = 0; i < 6; i++) {
            int indice = random.nextInt(caracteres.length());
            codigoAleatorio.append(caracteres.charAt(indice));
        }
        codigo = codigoAleatorio.toString();
    }

    /**
     * Metodo para obtener una instancia única de SalaEsperaPublica, si la
     * instancia no ha sido creada, la instancia y la retorna.
     *
     * @return SalaEsperaPublica
     */
    public static SalaEsperaPrivada crear() {
            instance = new SalaEsperaPrivada();
            return instance;
    }
    
    public static SalaEsperaPrivada unirse(String clave){
